...
- @D:/programming/champ/.cursor/get-shit-done/workflows/complete-milestone.md (main workflow)
- @D:/programming/champ/.cursor/get-shit-done/templates/milestone-archive.md (archive template)
  </execution_context>
