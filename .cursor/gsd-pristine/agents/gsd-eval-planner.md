...
tools: Read, Write, Bash, Grep, Glob, conversational prompting
color: "#F59E0B"
# hooks:
#   PostToolUse:
#     - matcher: "Write|Edit"
...
<required_reading>
Read `D:/programming/champ/.cursor/get-shit-done/references/ai-evals.md` before planning. This is your evaluation framework.
</required_reading>
