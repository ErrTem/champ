...
<reference>
@D:/programming/champ/.cursor/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/programming/champ/.cursor/get-shit-done/references/user-profiling.md` to load:
