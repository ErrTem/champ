...
<!-- For checkpoint task examples and patterns, see @D:/programming/champ/.cursor/get-shit-done/references/checkpoints.md -->
...
See `D:/programming/champ/.cursor/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/programming/champ/.cursor/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/programming/champ/.cursor/get-shit-done/workflows/verify-phase.md` for verification logic.
