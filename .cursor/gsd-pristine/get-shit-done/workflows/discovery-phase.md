...
See D:/programming/champ/.cursor/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using D:/programming/champ/.cursor/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using D:/programming/champ/.cursor/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from D:/programming/champ/.cursor/get-shit-done/templates/discovery.md
...
Use D:/programming/champ/.cursor/get-shit-done/templates/discovery.md.
