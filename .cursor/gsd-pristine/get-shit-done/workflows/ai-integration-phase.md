...
```markdown
Read D:/programming/champ/.cursor/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/programming/champ/.cursor/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/programming/champ/.cursor/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/programming/champ/.cursor/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/programming/champ/.cursor/agents/gsd-eval-planner.md for instructions.
