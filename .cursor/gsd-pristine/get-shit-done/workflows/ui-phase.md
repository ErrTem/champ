...
```markdown
Read D:/programming/champ/.cursor/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/programming/champ/.cursor/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/programming/champ/.cursor/agents/gsd-ui-checker.md for instructions.
