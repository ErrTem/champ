...
```bash
INIT=$(node "D:/programming/champ/.cursor/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/programming/champ/.cursor/get-shit-done/templates/spec.md.
