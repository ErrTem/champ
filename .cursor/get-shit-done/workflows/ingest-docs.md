...
```bash
INIT=$(node "D:/programming/champ/.cursor/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "D:/programming/champ/.cursor/get-shit-done/bin/gsd-tools.cjs" commit \
