...
<required_reading>
@D:/programming/champ/.cursor/get-shit-done/references/user-story-template.md
@D:/programming/champ/.cursor/get-shit-done/references/spidr-splitting.md
@D:/programming/champ/.cursor/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@D:/programming/champ/.cursor/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `conversational prompting` calls. Each is free-text. After all three, assemble into the canonical sentence per `@D:/programming/champ/.cursor/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@D:/programming/champ/.cursor/get-shit-done/references/spidr-splitting.md`. Briefly:
