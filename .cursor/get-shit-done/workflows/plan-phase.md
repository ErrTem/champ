...
@D:/programming/champ-app/.cursor/get-shit-done/references/revision-loop.md
...
**If found:**
1. Read template: `D:/programming/champ-app/.cursor/get-shit-done/templates/VALIDATION.md`
...
${TDD_MODE === 'true' ? `
<tdd_mode_active>
**TDD Mode is ENABLED.** Apply TDD heuristics from @D:/programming/champ-app/.cursor/get-shit-done/references/tdd.md to all eligible tasks:
