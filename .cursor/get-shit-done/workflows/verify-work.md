...
<template>
@D:/programming/champ-app/.cursor/get-shit-done/templates/UAT.md
</template>
...
Read and follow `D:/programming/champ-app/.cursor/get-shit-done/workflows/transition.md`.
...
```bash
node "D:/programming/champ-app/.cursor/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @D:/programming/champ-app/.cursor/get-shit-done/workflows/diagnose-issues.md
