...
INSTALL_JS_GLOBAL="D:/programming/champ/.cursor/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/programming/champ/.cursor/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
