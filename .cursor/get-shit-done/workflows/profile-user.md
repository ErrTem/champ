...
Key references:
- @D:/programming/champ-app/.cursor/get-shit-done/references/ui-brand.md (display patterns)
- @D:/programming/champ-app/.cursor/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/programming/champ-app/.cursor/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/programming/champ-app/.cursor/get-shit-done/USER-PROFILE.md"
...
```bash
cp "D:/programming/champ-app/.cursor/get-shit-done/USER-PROFILE.md" "D:/programming/champ-app/.cursor/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/programming/champ-app/.cursor/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/programming/champ-app/.cursor/get-shit-done/references/user-profiling.md`
...
Reference: @D:/programming/champ-app/.cursor/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to D:/programming/champ-app/.cursor/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .cursor/rules/" -- "Add profile to D:/programming/champ-app/.cursor/.cursor/rules/ for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/programming/champ-app/.cursor/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/programming/champ-app/.cursor/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to D:/programming/champ-app/.cursor/.cursor/rules/"
...
```bash
BACKUP_PATH="D:/programming/champ-app/.cursor/USER-PROFILE.backup.md"
```
...
Your profile:    D:/programming/champ-app/.cursor/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/programming/champ-app/.cursor/commands/gsd/dev-preferences.md
  ✓ .cursor/rules/ section       .cursor/rules/
  ✓ Global .cursor/rules/        D:/programming/champ-app/.cursor/.cursor/rules/
```
