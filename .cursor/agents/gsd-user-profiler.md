...
<reference>
@D:/programming/champ-app/.cursor/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/programming/champ-app/.cursor/get-shit-done/references/user-profiling.md` to load:
