...
<required_reading>
@D:/programming/champ-app/.cursor/get-shit-done/references/domain-probes.md
@D:/programming/champ-app/.cursor/get-shit-done/references/gate-prompts.md
@D:/programming/champ-app/.cursor/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
- Read and execute @D:/programming/champ-app/.cursor/get-shit-done/workflows/discuss-phase-power.md end-to-end
...
```bash
PROFILE_CONTENT=$(cat "D:/programming/champ-app/.cursor/get-shit-done/USER-PROFILE.md" 2>/dev/null || true)
```
...
2. For EACH user-selected gray area, spawn a Task() in parallel:
   ...
   Task(
     prompt="First, read @D:/programming/champ-app/.cursor/agents/gsd-advisor-researcher.md for your role and instructions.
...
**Full step-by-step instructions:** @D:/programming/champ-app/.cursor/get-shit-done/workflows/discuss-phase-power.md
