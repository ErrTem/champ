...
<execution_context>
@D:/programming/champ-app/.cursor/get-shit-done/workflows/note.md
...
<process>
Execute the note workflow from @D:/programming/champ-app/.cursor/get-shit-done/workflows/note.md end-to-end.
